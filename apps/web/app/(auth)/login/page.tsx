...
//       <Cloud
//         className="absolute right-10 top-20 hidden h-9 w-9 -rotate-6 text-[#B9B6A8] sm:block"
//         strokeWidth={1.5}
//       />
...
//           <Link href={`/signup?redirect=${encodeURIComponent(redirectTo)}`} className="font-medium text-[#15172B] underline underline-offset-2">
//             Sign up
//           </Link>
//         </div>
//       </div>
