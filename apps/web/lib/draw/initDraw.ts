...
//     if (tool === "select") return; // selection handled separately
...
//       drawShape(shape); // live preview stroke segment
//     }
//     // rect/circle/line/arrow live preview is handled by the caller re-rendering
//     // full canvas from store + a temp shape — kept simple here for the free-draw tools
//   };
